...
public final class DeadlineSubject extends ComparableSubject {
  private static final Subject.Factory<DeadlineSubject, Deadline> deadlineFactory = new Factory();
  ...
  /**
   * Prepares for a check that the subject is deadline within the given tolerance of an expected
  ...
  public abstract static class TolerantDeadlineComparison {
     ...
     * @deprecated {@link Object#equals(Object)} is not supported on TolerantDeadlineComparison If
     *     you meant to compare deadlines, use {@link #of(Deadline)} instead.
     */
